...
if __name__ == '__main__':
    ...
    parser.add_argument('--standardize_covar', default = False, type = bool, help = "standardization of covariates" )
    parser.add_argument('--dlatent', default = "16,256,4", help = "latent dimension for encoding (mu)" )
